...
#define TINYLINK_LIGHT GROVE_DIGITAL_LIGHT

// Temperature
#define TINYLINK_TEMPERATURE TH02
/*
...
// Skin current
#define TINYLINK_SKIN_CURRENT GROVE_GSR
#define SKIN_CURRENT_ANALOG A0
