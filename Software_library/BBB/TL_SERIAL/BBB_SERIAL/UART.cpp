...
HardwareSerial TL_Serial3(5);  // UART5
#endif

#if (P9_11_MODE == uart) || (P9_13_MODE == uart)
HardwareSerial TL_Serial2(4);  // UART4
#endif

#if (P9_21_MODE == uart) || (P9_22_MODE == uart)
HardwareSerial TL_Serial1(2);  // UART2
#endif

#if (P9_24_MODE == uart) || (P9_26_MODE == uart)
HardwareSerial TL_Serial(1);  // UART1
#endif
