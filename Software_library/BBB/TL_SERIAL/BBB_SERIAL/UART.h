...
extern HardwareSerial TL_Serial3;  // UART5
#endif

#if (P9_11_MODE == uart) || (P9_13_MODE == uart)
extern HardwareSerial TL_Serial2;  // UART4
#endif

#if (P9_21_MODE == uart) || (P9_22_MODE == uart)
extern HardwareSerial TL_Serial1;  // UART2
#endif

#if (P9_24_MODE == uart) || (P9_26_MODE == uart)
extern HardwareSerial TL_Serial;  // UART1
#endif
