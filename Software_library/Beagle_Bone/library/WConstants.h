...
// Modified form of original WConstants.h
// Changes : Commented out defines which are not required
...
//#define abs(x)                         ((x)>0?(x):-(x))
 // edited by fkb 16/11/24 min -> min_fkb
#define min_fkb(a,b)                       ((a)<(b)?(a):(b))
// edited by fkb 16/11/24 max -> max_fkb
#define max_fkb(a,b)                       ((a)>(b)?(a):(b))
